...
if(!message.member.permissions.has('MANAGE_NICKNAMES')) return message.channel.send(new Discord.MessageEmbed().setThumbnail(message.author.avatarURL() ? message.author.avatarURL({dynamic: true}) : 'https://cdn.glitch.com/8e70d198-9ddc-40aa-b0c6-ccb4573f14a4%2F6499d2f1c46b106eed1e25892568aa55.png').setTitle('Bir hata oldu!').setDescription(`• t!isim\` kullanmak için, \`Kullanıcı Adlarını Yönet\` **yetkisine sahip olman gerekiyor.**`));
